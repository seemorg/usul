...
export default async function TeamPage() {
  ...
  return (
    <Container className="max-w-5xl pt-8 lg:pt-12 2xl:max-w-6xl">
      ...
      <div className="mt-14">
        <h1 className="text-1xl lg:text-2xl">{t("engineering-team-title")}</h1>
      ...
      <div className="mt-14">
        <h1 className="text-1xl lg:text-2xl">
          {t("research-annotation-team-title")}
        </h1>
      ...
      <div className="mt-14">
        <h1 className="text-1xl lg:text-2xl">{t("past-team-members-title")}</h1>

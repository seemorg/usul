...
export default function RootEntityPage({
  ...
  return (
    <>
      <div className="bg-muted-primary flex h-fit min-h-[250px] w-full items-start justify-center pt-16 text-white sm:min-h-[300px] sm:pt-24">
        <Container className="flex flex-col sm:flex-row justify-start">
          <Container className="flex-1/3 flex flex-col items-center justify-start">
            <h1 className="text-6xl font-bold text-center sm:text-7xl">{title}</h1>
            {subtitle && (

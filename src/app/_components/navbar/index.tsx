...
export default function Navbar({ isHomepage, secondNav }: NavbarProps) {
  ...
  return (
    <>
      <header
        className={cn(
          "relative top-0 z-[41] flex h-16 w-full items-center justify-between gap-4 bg-primary px-4 text-white transition sm:gap-8 lg:h-20 lg:px-10 xl:grid xl:grid-cols-12",
          showNavbar
